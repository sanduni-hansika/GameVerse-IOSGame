    ...
    private var chartCard: some View {
        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            if sessions.isEmpty {
                ...
                Chart(Array(sessions.enumerated()), id: \.element.id) {
                    index,
                    session in
                    ...
                    .symbol {
                        ...
                        Circle()
                            .fill(
                                selectedMode.colors.first ?? .blue
                            )
                            .frame(
                                width: 11,
                                height: 11
